...
function generateDemoData() {
  console.log('🚀 8月1日-31日期間デモデータ生成開始...');
  ...
  // ファイル保存
  fs.writeFileSync('demo_data_august_system_presets.json', JSON.stringify(demoData, null, 2));
  ...
  console.log('\n✅ デモデータ生成完了: demo_data_august_system_presets.json');

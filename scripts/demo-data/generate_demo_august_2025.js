...
/**
 * 8/1-8/31 システムプリセット準拠のデモ申請予定と担当設定生成スクリプト
...
if (require.main === module) {
  ...
  const filename = 'demo_data_august_2025.json';
  fs.writeFileSync(filename, JSON.stringify(demoData, null, 2));
  
  console.log(`\n💾 ファイル保存完了: ${filename}`);
  console.log('🎉 8月デモデータ生成完了！');
}

module.exports = { generateAugustDemoData };